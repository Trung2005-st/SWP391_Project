...
import DailyProgressPage from "./Pages/userPlan/dailyCheck/dailyCheck";
import ReportHistoryPage from "./Pages/userPlan/reportHistory/ReportHistoryPage";
import AppointmentUpdate from "./Pages/profile/updateAppointment/appointmentForm";
import AppointmentView from "./Pages/profile/viewAppointment/appointmentForm";
import EditBlogPage from "./Pages/profile/editBlog/editBlog";
...
function Router() {
  const router = createBrowserRouter([
    ...
    },
    {
      ...
      element: <DailyProgressPage></DailyProgressPage>,
      loader: requireAuthLoader,
    },
    {
    ...
    {
      path: ROUTES.APPOINTMENT_UPDATE,
      element: <AppointmentUpdate />,
      loader: requireAuthLoader,
    },
    {
      path: ROUTES.APPOINTMENT_VIEW,
      element: <AppointmentView />,
      loader: requireAuthLoader,
    },
    {
      path: "/blogManager/edit/:id",
