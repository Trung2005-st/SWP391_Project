...
public class ForgotPasswordAPI {
    ...
    public ResponseEntity forgotPassword(@Valid @RequestBody ForgotPasswordRequest forgotPasswordRequest){
        ...
        return ResponseEntity.ok("OTP sent to " + forgotPasswordRequest.getEmail());
    }

    @PostMapping("/api/verify-otp")
    public ResponseEntity verifyOtp(@RequestBody VerifyEmailRequest verifyEmailRequest){
        String resetToken = forgotPasswordService.requestOtp(verifyEmailRequest);
        return ResponseEntity.ok("OTP Verified successfully, Reset Token: " + resetToken);
    }
